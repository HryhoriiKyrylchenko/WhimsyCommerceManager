...
{
    /// <summary>
    /// Represents a translated version of a user agreements in a specific language.
    /// </summary>
    [Table("UserAgreementTranslations")]
    public class UserAgreementTranslation
    {
        /// <summary>
        ...
        /// This navigation property links to the <see cref="UserAgreement"/>.
        /// </summary>
        [ForeignKey(nameof(UserAgreementId))]
        public virtual UserAgreement UserAgreement { get; set; } = null!;

        /// <summary>
        /// Gets or sets the text of the agreement.
        /// </summary>
        [Required]
